...
if (!function_exists('is_pluralizable')) {
    ...
    function is_pluralizable(string $word): bool
    {
        $uncountables = [
            ...
            'honesty', 'information', 'insurance', 'jewelry', 'knowledge', 'livestock', 'love', 'luck',
            'marketing', 'meta', 'money', 'mud', 'news', 'patriotism', 'racism', 'rice', 'satisfaction',
            'scenery', 'series', 'sexism', 'silence', 'species', 'spelling', 'sugar', 'water', 'weather',
            'wisdom', 'work',
        ];

        return !in_array(strtolower($word), $uncountables, true);
    }
}
